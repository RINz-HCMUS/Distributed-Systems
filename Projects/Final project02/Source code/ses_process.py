...
class SESProcess:
    def __init__(self, config_node, all_nodes_config, logger, network):
        ...
        self.expected_total = 0 # = TOTAL_MESSAGES_PER_PAIR * (TOTAL_PROCESSES - 1)
        self.finished = False

    def check_finish(self):
        """
        Kiểm tra điều kiện hoàn thành
        Điều kiện hoàn thành: Gửi đủ + Nhận đủ + Buffer trống
        """
    ...
    # Kiểm tra điều kiện (deliver or buffer)
    ...
    # Kiểm tra lại buffer sau mỗi lần deliver
